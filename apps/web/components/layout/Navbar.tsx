...
export function Navbar({
  ...
  return (
    <div className="sticky top-0 z-20 bg-background/50 before:backdrop-blur-lg before:absolute before:inset-0 before:-z-[1] before:w-full">
      <div className="flex flex-row gap-2 px-4 py-2 mx-auto min-h-[52px]">
        <button
          className={cn(
            button({
